...
// ЛАБОРАТОРНАЯ РАБОТА: СТРУКТУРЫ ДАННЫХ ДЛЯ ЗАПРОСОВ НА ОТРЕЗКАХ спасите
...
// Самая простая структура +реп! Идея в том, что мы заранее считаем кумулятивные суммы.
...
// вычесть prefix[l] из prefix[r+1]. Потому что prefix[r+1] содержит
...
// Эти два отрезка могут пересекаться, но для минимума по барабану вроде
